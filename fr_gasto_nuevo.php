...
<div id="dialog_buscar_requisiciones" class="modal fade bd-example-modal-lg" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="row">
               <label for="s_filtro_unidad_r" class="col-sm-12 col-md-2 col-form-label">Unidad Negocio </label>
                        ...
                        {  
                            if(diferentesFamilias == 0)
                                ...
                                if(diferentesFamilias == 1 && ((arr[0] == arr[1]) || (arr[0] == arr[2]) || (arr[0] == arr[3])))
                                {
                                    ...
                                    mandarMensaje('Todas las clasficaciones de las partidas deben ser CAJA CHICA ó VALES 1');
                                    $('#b_guardar').prop('disabled',false);
                                }
                            }
                        }else{
                    ...
                    if($("#ch_deudores").is(':checked'))
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    mandarMensaje('Todas las clasficaciones de las partidas deben ser CAJA CHICA ó VALES 2');
                                    $('#b_guardar').prop('disabled',false);
                                }
                        ...
                        {  
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        mandarMensaje('Todas las clasficaciones de las partidas deben ser CAJA CHICA ó VALES 3');
                                        console.log('DF ' + diferentesFamilias);
                                        console.log('1 ' + arr[0] + ' **  ' + arr[1]);
                                        console.log('2 ' + arr[0] + ' **  ' + arr[2]);
                                        console.log('3 ' + arr[0] + ' **  ' + arr[3]);
                                        $('#b_guardar').prop('disabled', false);
                                    }
      ...
      function limpiarProveedor(){
        ...
        function buscarRequisicion(){
            ...
            $.ajax({
                ...
                dataType:"json", 
                data:{
                    'idUnidadNegocio':$('#s_filtro_unidad_r').val(),
                    'idSucursal':$('#s_filtro_sucursal_r').val(),
                ...
                success: function(data)
                {
                    ...
                    for(var i=0; data.length>i; i++)
                    {
                        ...
                        alert('verifncando ' + requisicion.folio + ' * '  + requisicion.b_varias_familias);
        ...
        $("#t_requisiciones_b").on('click',".requisicion-busqueda",function()
        {
            ...
            alert('DF' + $(this).parent().attr('alt3'));
