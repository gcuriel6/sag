            ...
            <br>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-5 col-lg-4">
                         <span style="color:#000099; font-size: 25px;">Reporte Almacén Producto Term.</span>
                    </div>
...
<script>
  ...
  $(function()
  {
        ...
        success: function(data) 
        {
          ...
          {             
            ...
            for(var i=0;data.length>i;i++)
            {
              ...
              var html = '<tr class="renglon_pedido">';
              html += '<td data-label="Folio Factura">' + data[i].folio_factura + '</td>';
              html += '<td data-label="Fecha">' + data[i].fecha + '</td>';
              html += '<td data-label="Producto">' +  data[i].producto  + '</td>';
              html += '<td data-label="Tipo"><label style="background-color: rgb(232, 232, 232); color: black; border-radius: 5px; border: 2px solid #73AD21;">ENTRADA</label></td>';
              html += '<td data-label="Cantidad">' + data[i].total_producto + '</td>';
              html += '</tr>';

              html = '<tr class="renglon_pedido">';
              html += '<td data-label="Folio Factura">' + data[i].folio_factura + '</td>';
              html += '<td data-label="Fecha">' + data[i].fecha + '</td>';
              html += '<td data-label="Producto">' +  data[i].producto  + '</td>';
              html += '<td data-label="Tipo"><label style="background-color: rgb(232, 232, 232); color: black; border-radius: 5px; border: 2px solid #ff0000;">SALIDA</label></td>';
              html += '<td data-label="Cantidad">' + data[i].total_producto + '</td>';
              html += '</tr>';
    ...
    $('#b_excel').click(function()
    {
      ...
      $('#i_nombre_excel').val('Almacén Producto Term.');
      $('#i_fecha_excel').val(hoy);
      $('#i_modulo_excel').val('REPORTE_PRODUCTO_TERM');
