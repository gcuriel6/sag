            ...
            <br>
                <div class="row">
                    <div class="col-sm-12 col-md-4">
                        <div class="titulo_ban">Salida Por Comodato</div>
                    </div>
                ...
                <form id="forma_salida_comodato" name="forma_salida_comodato">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-4">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input type="text" id="i_tipo_salida" name="i_tipo_salida" value="S06 Salida Por Comodato" class="form-control form-control-sm" autocomplete="off" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <label for="i_departamento" class="col-sm-12 col-md-12 col-form-label requerido">Departamento </label>
                                <div class="input-group col-sm-12 col-md-12">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn btn-primary" type="button" id="b_buscar_departamento" style="margin:0px;">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="row">
                                <label for="i_area" class="col-md-3 col-form-label requerido">Área</label>
                                <div class="col-sm-12 col-md-8">
                                    <input type="text" id="i_area" name="i_area" class="form-control form-control-sm validate[required]" readonly autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="row">
                                <label for="i_supervisor" class="col-md-4 col-form-label requerido">Supervisor</label>
                                <div class="col-sm-12 col-md-8">
                                    <input type="text" id="i_supervisor" name="i_supervisor" class="form-control form-control-sm validate[required]" readonly autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
...
<div id="dialog_buscar_salidas_comodato" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Búsqueda de  Salidas Por Comodato</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <input type="text" name="i_filtro_salidas_comodato" id="i_filtro_salidas_comodato" alt="renglon_salidas_comodato" class="form-control filtrar_renglones" placeholder="Filtrar" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>    
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <table class="tablon"  id="t_salidas_comodato">
                            <thead>
                                <tr class="renglon">
...
<div id="dialog_departamentos" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-10"><input type="text" name="i_filtro_departamento" id="i_filtro_departamento" alt="renglon_departamento" class="filtrar_renglones form-control filtrar_renglones" placeholder="Filtrar" autocomplete="off"></div>
                </div>    
                <br>
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <table class="tablon"  id="t_departamento">
                        <thead>
                            <tr class="renglon">
...
<script>
    ...
    $(function(){
        ...
        $('#s_id_unidades').change(function(){
            ...
            $('#i_area,#i_departamento,#i_supervisor').val('').attr('alt',0);
        ...
        $('#b_buscar_departamento').click(function(){
            if(($('#s_id_unidades').val() != null) && ($('#s_id_sucursales').val() != null))
            {
                $('#i_filtro_departamento').val('');
                muestraModalDepartamentosSucursal('renglon_departamento','t_departamento tbody','dialog_departamentos',$('#s_id_sucursales').val());
            }else{
                mandarMensaje('Seleccionar Unidad de Negocio y Sucursal para buscar información');
            }
        });

        $('#t_departamento').on('click', '.renglon_departamento', function() {
            var id = $(this).attr('alt');
            var nombre = $(this).attr('alt2');
            $('#i_departamento').attr('alt',id).val(nombre);

            $('#i_area').val($(this).attr('alt3'));
            $('#i_supervisor').val($(this).attr('alt4'));

            $('#dialog_departamentos').modal('hide');
        });
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        for(var i=0; data.length>i; i++)
                        {
                            ...
                            var html = "<tr class='tr_producto' alt='" + producto.id + "'  alt2='" + producto.concepto+ "' alt3='" + producto.id_familia + "' alt4='" + producto.familia + "' alt5='" + producto.id_linea + "' alt6='" + producto.linea + "' alt7='" + producto.costo + "' alt8='" + producto.descripcion + "' alt9='" + producto.existencia + "' servicio='"+producto.servicio+"' familia_gasto='"+producto.id_familia_gasto+"'>";
        ...
        $("#t_productos").on('click','.tr_producto',function(){
            ...
            //{
                ...
                var existencia = $(this).attr('alt9');
                var servicio = $(this).attr('servicio');
                //-->NJES June/18/2020 se agrega proiedad para obtener el id familia gasto del producto
                ...
                else
                {
                    ...
                    $('#i_familia').attr({'alt':idFamilia,'familia_gasto':idFamiliaGasto}).val(familia);
        ...
        $('#b_agregar_producto').click(function(){
            ...
            if($('#form_partidas').validationEngine('validate'))
            {
                ...
                //-->NJES June/18/2020 se agrega proiedad para obtener el id familia gasto del producto
                var idFamiliaGasto = $('#i_familia').attr('familia_gasto');
                ...
                if(servico == 0 && verificaE > 0)
                {
                    ...
                    var html = "<tr class='partida' producto='" + idProducto + "' servicio='"+servico+"' concepto='" + concepto+ "' id_familia='" + idFamilia + "' familia='" + familia + "' id_linea='" + idLinea + "' linea='" + linea + "' precio='" + precio + "' cantidad='" +  cantidad + "' descripcion='" + descripcion + "' importe='" + importe + "' marca='"+marca+"' existencia='"+existencia+"' familia_gasto='"+idFamiliaGasto+"'>";
        ...
        $('#b_guardar').click(function(){
            ...
            if ($('#forma_salida_comodato').validationEngine('validate')){
                if($('#t_registros .partida').length > 0)
                {
                    ...
                    mandarMensaje('Debe existir por lo menos un producto para generar la salida por comodato de sucursal');
        ...
        function guardar(){
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data > 0 )
                    { 
                        mandarMensaje('La salida por comodato: '+data+' se guardó correctamente');
                        limpiar();
        ...
        $('#b_buscar').click(function(){
            ...
            $('#i_filtro_salidas_comodato').val('');
            $('#i_fecha_inicio').val('');
            $('#i_fecha_fin').val('').prop('disabled',true);
            $('.renglon_salidas_comodato').remove();
            $('#dialog_buscar_salidas_comodato').modal('show');
        ...
        $(document).on('change','#s_filtro_sucursal',function(){
            buscarSalidasPorComodato($('#s_filtro_unidad').val());
        });
        ...
        function buscarSalidasPorComodato(idUnidadNegocio){
            $('.renglon_salidas_comodato').remove();
                ...
                success: function(data) {
                    if(data.length != 0){
                        ...
                        for(var i=0;data.length>i;i++){
                            ...
                            ///llena la tabla con renglones de registros
                            var html='<tr class="renglon_salidas_comodato" alt="'+data[i].id+'" alt2="'+data[i].id_unidad_negocio+'" alt3="'+data[i].id_sucursal+'">\
                            ...
                            ///agrega la tabla creada al div 
                            $('#t_salidas_comodato tbody').append(html);   
        ...
        $('#t_salidas_comodato').on('click', '.renglon_salidas_comodato', function() {
            muestraSucursalesPermiso('s_id_sucursales',$(this).attr('alt2'),modulo,idUsuario);
            idSalidaComodato = $(this).attr('alt');
            $('#dialog_buscar_salidas_comodato').modal('hide');
            muestraRegistro(idSalidaComodato);
            muestraRegistroDetalle(idSalidaComodato); 
            $('#b_guardar,#b_agregar_producto,#b_buscar_productos,#b_buscar_departamento').prop('disabled',true);
            $('#b_imprimir').prop('disabled',false);
            $('#forma_salida_comodato').find('input,select').prop('disabled',true);
            $('#form_partidas input').prop('disabled',true);
            
        });

        function muestraRegistro(idSalidaComodato){
            $.ajax({
                type: 'POST',
        ...
        function muestraRegistroDetalle(idSalidaComodato){
        ...
        $('#b_imprimir').click(function(){
            ...
            var datos = {
                ...
                'idRegistro':idSalidaComodato,
                'nombreArchivo':'salida_por_comodato',
                'tipo':1,
                'concepto':'S06 Salida Por Comodato'
            };
        ...
        function limpiar(){
            muestraSelectUnidades(matriz,'s_id_unidades',idUnidadActual);
            muestraSucursalesPermiso('s_id_sucursales',idUnidadActual,modulo,idUsuario);
            $('#i_num_movimiento,#i_area,#i_departamento,#i_supervisor').val('');

            $('#form_partidas input').val('');
            $('select').prop('disabled',false);
            $("#t_registros tr").remove();
            $('#b_guardar,#b_agregar_producto,#b_buscar_productos,#b_buscar_departamento').prop('disabled',false);

            $('#forma_salida_comodato').validationEngine('hide');
            $('#form_partidas').validationEngine('hide');
