        ...
        <div class="row">
            ...
            <br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-2">
                        <button type="button" class="btn btn-success btn-sm form-control"  id="b_buscar_cuentas"><i class="fa fa-search" aria-hidden="true"></i> Buscar Cuentas</button>
                    </div>
                    <div class="col-md-6">
...
///-------------- DETALLES DE LAS CUENTAS Y BUQEDA DE CUENTAS PARA CAMBIAR A OTRA CUENTA------------
            ...
            $.ajax({
                ...
                if(data.length != 0){
                        ...
                        for(var i=0;data.length>i;i++){
                            ...
                            var html='<tr class="renglon_cuentas" alt="'+data[i].id+'" alt2="'+data[i].id_unidad_negocio+'" alt3="' + data[i].cuenta+ '">\
        ...
        $(document).on('click','#b_excel_movimientos',function(){
            ...
            if($('.renglon_movimientos').length>0){ 
                ...
                var idCuenta = $(this).attr('alt');
                var cuenta = $(this).attr('alt2');
                ...
                $("#i_nombre_excel").val('Reporte Movimientos Cuenta:  '+cuenta);
                $("#i_fecha_excel").val($('#i_fecha').val());
                $('#i_modulo_excel').val(modulo);
                $('#i_datos_excel').val(JSON.stringify(datos));
