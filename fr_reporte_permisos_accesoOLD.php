            ...
            <br>
                ...
                <div class="row form-group">
                    <div class="col-sm-12 col-md-4">
                        <div class="row">
                            <label for="i_menu" class="col-sm-12 col-md-3 col-form-label">Menú </label>
                                ...
                                <div class="row">
                                    <div class="input-group col-sm-12 col-md-12">
                                        ...
                                        <div class="input-group-btn">
                                            <button class="btn btn-primary" type="button" id="b_buscar_menu" style="margin:0px;">
                    ...
                    <div class="col-sm-12 col-md-5">
                        <div class="row">
                            <label for="i_restriccion" class="col-sm-12 col-md-4 col-form-label">Permiso/Restricción</label>
                            <div class="col-sm-12 col-md-7">
                                <div class="row">
                                    <div class="input-group col-sm-12 col-md-12">
                                        ...
                                        <div class="input-group-btn">
                                            <button class="btn btn-primary" type="button" id="b_buscar_restriccion" style="margin:0px;" disabled>
                                                <i class="fa fa-search" aria-hidden="true"></i>
                                            </button>
                                        </div>
                                    </div>
...
<div id="dialog_menu" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<div id="dialog_restriccion" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
