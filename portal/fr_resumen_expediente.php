	...
	<body>
		  ...
		  <div class="container-fluid">
		    ...
		    <div>
		      <ul class="nav navbar-nav">
		        <li class="active"><a href="fr_resumen_expediente.php" target="_self">Expediente</a></li>
		        <li class="li_bajas"><a href="fr_resumen_expediente_b.php" target="_self">Bajas</a></li>
		...
		<div id="vidrio">
			...
			<?php
				...
				for ($i = 0; $i < $cont; $i++)
				{
					...
					if ($accesos[$i][2] != 3) {
						...
						if (trim($dep) != '') {
							...
							$query = "SELECT
											a.id_trabajador AS id,
											CONCAT(a.apellido_p,' ',a.apellido_m,' ',a.nombre) AS 'nombre completo',
											b.puesto,
											c.des_dep AS 'departamento',
											c.cve_dep AS 'clave'
										FROM trabajadores a
										LEFT JOIN cat_puestos b ON a.id_puesto = b.id_puesto
										LEFT JOIN deptos c ON a.id_depto = c.id_depto
										WHERE a.id_sucursal = '$suc' AND a.id_depto IN ($dep) AND fecha_baja = '0000-00-00' ";

							TablaQuery($query, $link, "SUCURSAL $sucur", "php/detalle_trabajador.php", "id", "nombre completo");
							//echo "con";
						} else {
				...
				LEFT JOIN cat_puestos b ON a.id_puesto = b.id_puesto
				LEFT JOIN deptos c ON a.id_depto = c.id_depto
				WHERE a.id_sucursal = '$suc' AND fecha_baja = '0000-00-00'", $link, "SUCURSAL $sucur", "php/detalle_trabajador.php", "id", "nombre completo");
							//echo "sin";
						}
					}
				}
