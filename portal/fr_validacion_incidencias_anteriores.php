	...
	<script>
		...
		$(document).ready(function() {
			...
			function llenaTabla(){
				...
				$.post('php/busca_incidencias_anteriores.php',{},function(data){
		  ...
		  <div class="container-fluid">
		    ...
		    <div>
		      <ul class="nav navbar-nav">
		        ...
		        <li class="active"><a href="fr_validacion_incidencias_anteriores.php">Sin Validar</a></li>
		      	<li><a href="fr_validacion_incidencias_dia.php">Busca Dia</a></li>
