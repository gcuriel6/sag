...
$(function() 
	{
		...
		var idUs = <?php echo $idUsuario?>;
		console.log('id usuario '  + idUs);

		var idTra = <?php echo $id_trabajador?>;
		console.log('id trbajador '  + idTra);

		var idSu = <?php echo $sucursal?>;
		console.log('id sucursal '  + idSu);
