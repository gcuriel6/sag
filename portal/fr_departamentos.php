		...
		function actualizaDeptos(){
			$.post('php/busca_deptos.php',{sucursal:$('#s_sucursales').val()},function(data){	
				...
				for(var i = 1; i<= num;i++){
					...
					//--MGFS 13-01-2020 SE QUITA EL CAMPO OBSERVACIONES (<td>"+dato.servicio+"</td>)
					html = "<tr class='renglon_depto'><td>"+dato.cve_dep+"</td><td>"+dato.des_dep+"</td><td class='td_inactivo' alt='"+activo+"'>"+boton+"</td><td class='td_presupuesto' alt='"+presupuesto+"'>"+boton2+"</td></tr>";
