            ...
            <br>
                <div class="form-group row">
                    <div class="col-sm-12 col-md-4">
                        <div class="titulo_ban">Reportes de Vales de Gasolina</div>
                    </div>
...
<script>
    ...
    $(function(){
        ...
        $('#b_pdf').click(function(){
            ...
            var datos = {
                    'path':'formato_vales_gasolina_sucursal',
                    'idRegistro':$('#s_id_sucursales').val(),
                    'fechaInicio':fechaInicio,
                    'fechaFin':fechaFin,
                    'nombreArchivo':'vales_gasolina_'+$('#s_id_sucursales options:selected').text(),
                    'tipo':3
                };
        ...
        $('#b_excel').click(function(){
            ...
            $("#i_nombre_excel").val('Reportes Vales de Gasolina');
            $("#i_fecha_excel").val(hoy);
            $('#i_modulo_excel').val('REPORTE_VG');
