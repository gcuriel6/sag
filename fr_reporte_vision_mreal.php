            ...
            <br>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-5 col-lg-4">
                         <span style="color:#000099; font-size: 25px;">Reporte Merma Real</span>
                    </div>
...
<script>
  ...
  $(function()
  {
        ...
        success: function(data) 
        {
          ...
          {             
            ...
            for(var i=0;data.length>i;i++)
            {
              ...
              html += '<td data-label="Clave Producto">' + data[i].clave_producto + '</td>';
              html += '<td data-label="Concepto">' + data[i].concepto + '</td>';
              html += '<td data-label="Merma Real">' + data[i].m_real  + '</td>';
              html += '<td data-label="Fam.">' + data[i].fam + '</td>';
              html += '<td data-label="Linea">' + data[i].linea + '</td>';
              html += '</tr>';
    ...
    $('#b_excel').click(function()
    {
      ...
      $('#i_nombre_excel').val('Merma Real');
      $('#i_fecha_excel').val(hoy);
      $('#i_modulo_excel').val('REPORTE_PEDIDOS_REAL');
