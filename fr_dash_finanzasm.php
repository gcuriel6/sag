        ...
        <div class="row">
            ...
            <div class="col-md-10 div_contenedor">
                <div class="row justify-content-between mb-3">
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-success" id="b_excel"><i class="fa fa-file-excel-o" ></i> Excel Facturas</button>
                    </div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-success" id="b_excel2"><i class="fa fa-file-excel-o" ></i> Excel Notas</button>
                    </div>
                </div>
                <div class="row">
                    ...
                    <?php
                        ...
                        // mostrarRegistrosDetalle($('#s_id_unidades').val(),
                        //                         $('#s_id_sucursales').val(), // muestraSucursalesPermisoListaId($('#s_id_unidades').val(),modulo,idUsuario)
                        //                         $('#i_empresa_fiscal').attr('alt'),
                        //                         fechaI,
                        //                         fechaF,
                        //                         'facturado',
                        //                         '',
                    ...
                    <div class="col-md-6">
                        <label for="s_empresa_fiscal-url">Empresa Fiscal (emisora)</label>
                        <div class="input-group">
                            <input type="text" id="i_empresa_fiscal" name="i_empresa_fiscal" class="form-control validate[required]" readonly autocomplete="off">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label for="s_id_unidades">Unidad de Negocio </label>
                        <select id="s_id_unidades" name="s_id_unidades" class="form-control validate[required]""></select>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <label for="s_id_sucursales">Sucursal</label>
                        <select id="s_id_sucursales" name="s_id_sucursales" class="form-control validate[required]"></select>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <label>Al: </label>
                        <div class="input-group">
                            <input type="text" name="i_fecha_fin" id="i_fecha_fin" class="form-control fecha" autocomplete="off" readonly>
                            <div class="input-group-addon input_group_span">
                                <span class="input-group-text">
                                    <i class="fa fa-calendar" aria-hidden="true"></i>
                                </span>
                    ...
                    <div class="col-md-4 mt-auto mb-0">
                        <button class="btn btn-success btn-block mb-0" id="btn_buscar_reporte_detallado">Buscar</button>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="fact-tab" data-toggle="tab" href="#fact" role="tab">Facturas</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="notas-tab" data-toggle="tab" href="#notas" role="tab">Notas de Credito</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="fact" role="tabpanel">
                                <div class="row">
                                    <div class="col-12">
                                                ...
                                                <table class="tablon">
                                                    <thead>
                                                        <tr class="renglon">
                                                            ...
                                                            <th scope="col" class="fecha_aplicacion">Fecha Aplicación Pago</th>
                                                        </tr>
                                                    </thead>
                                                </table>
                            ...
                            <div class="tab-pane fade" id="notas" role="tabpanel">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row form-group" id="div_registros2">
                                            <div class="col-sm-12 col-md-12">
                                                <table class="tablon">
                                                    <thead>
                                                        <tr class="renglon">
                                                ...
                                                <div class="div_t_registros">
                                                    <table class="tablon"  id="t_registros_detalle2">
                                                        <tbody>
                                                        ...
                                                        <table class="tablon">
                                                            <tbody>
                                                                <tr>
                                                                    <th class="unidad_hide"></th>
                                                                    <th class="sucursal_hide"></th>
                                                                    <th id="th_totales2" colspan="5"></th>
                                                                    <th>Totales</th>
                                                                    <th data-label="Subtotal"><input type="text" id="i_subtotal_facturado2" name="i_subtotal_facturado" class="totales form-control form-control-sm" autocomplete="off" readonly></th>
                                                                    <th data-label="Total Facturado"><input type="text" id="i_total_facturado2" name="i_total_facturado" class="totales form-control form-control-sm" autocomplete="off" readonly></th>
                                                                    <th data-label="Total Cobrado"><input type="text" id="i_total_cobrado2" name="i_total_cobrado" class="totales form-control form-control-sm" autocomplete="off" readonly></th>
                                                                    <th data-label="Total Saldo"><input type="text" id="i_total_saldo2" name="i_total_saldo" class="totales form-control form-control-sm" autocomplete="off" readonly></th>
                                                                    <th colspan="2"></th>
                                                                </tr>
                                                            </tbody>
                                                        </table>
...
<script>
    ...
    $(function()
    {
        ...
        $('#b_excel').click(function()
        {
            ...
            let idSucursal = $('#s_id_sucursales').val();
            let idUnidad = $('#s_id_unidades').val();
            let idEmpresaFiscal = $('#i_empresa_fiscal').attr('alt');
            let fechaI = $("#i_fecha_inicio").val();
            let fechaF = $("#i_fecha_fin").val();

            if(idSucursal == null || idSucursal == undefined){
                // idSucursal = muestraSucursalesPermisoListaId(listaUnidadesNegocioId(matriz),modulo,idUsuario);
                idSucursal = muestraSucursalesPermisoListaId(idUnidad,modulo,idUsuario);
            }

            if(fechaI == "" && fechaF != ""){
                $("#i_fecha_inicio").addClass("is-invalid");
            }else{
                $("#i_fecha_inicio").removeClass("is-invalid");

                if(idEmpresaFiscal == undefined){
                    idEmpresaFiscal = 0;
                }
                ...
                $("#i_fecha_excel").val(hoy);
                $('#i_modulo_excel').val('DASH_FINANZAS2');
                $('#i_datos_excel').val(JSON.stringify(datos));
        ...
        $('#b_excel2').click(function()
        {
            ...
            if(fechaI == "" && fechaF != ""){
                ...
                $("#i_nombre_excel").val('Dash Finanzas Detalle');
                $("#i_fecha_excel").val(hoy);
                //GCM - 05/11/2021 - se manda DASH_FINANZAS3 para el reporte de excel que incluye solamente notas de credito
                $('#i_modulo_excel').val('DASH_FINANZAS3');
                $('#i_datos_excel').val(JSON.stringify(datos));
        ...
        $("#btn_buscar_reporte_detallado").on("click",()=>{
            ...
            */
            ...
            if(fechaI == "" && fechaF != ""){
                ...
                mostrarRegistrosDetalle2(idUnidad,idSucursal,idEmpresaFiscal,fechaI,fechaF);
            }
        });

        function mostrarRegistrosDetalle2(idUnidadNegocio,idSucursal,idEmpresaFiscal,fechaI,fechaF){
            ...
            $('#t_registros_detalle tbody').html('');
            $('#t_registros_detalle2 tbody').html('');
           
            $.ajax({
                type: 'POST',
                url: 'php/dash_finanzas_buscar2.php',
                dataType:"json", 
                data:  {'datos':datos},
                success: function(data) {
                        ...
                        for(var i=0;data.length>i;i++){
                            ...
                            if(idUnidadNegocio != '')
                            {
                                ...
                                if(res == ',')
                                {
                                    ...
                                    var columnaUnidad = '<td data-label="Unidad de Negocio"></td>';
                                }
                            }
                            ...
                            if(idSucursal != '')
                            {
                                ...
                                if(res == ',')
                                {
                                    ...
                                    var columaSucursal = '<td data-label="Sucursal"></td>';
                                }
                            }
                    ...
                    //para las notas de creditos, query igual al anterior pero para notas
                    // totalFacturado=0;
                    // totalCobrado=0;
                    // totalSaldo=0;
                    // totalSubtotal=0;
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'php/dash_finanzas_buscar3.php',
                        dataType:"json", 
                        data:  {'datos':datos},
                        success: function(data) {
                            ...
                            if(data.length != 0){
                                ...
                                for(var i=0;data.length>i;i++){
                                    ...
                                    ///agrega la tabla creada al div 
                                    $('#t_registros_detalle2 tbody').append(html);   
                                ...
                                // $('#i_subtotal_facturado2').val(formatearNumero(totalSubtotal));
                                // $('#i_total_facturado2').val(formatearNumero(totalFacturado));
                                // $('#i_total_cobrado2').val(formatearNumero(totalCobrado));
                                // $('#i_total_saldo2').val(formatearNumero(totalSaldo));
                        ...
                        error: function (xhr) 
                        {
                            console.log('php/dash_finanzas_buscar3.php --> '+JSON.stringify(xhr));
                            mandarMensaje('* No se encontró información de Detalle Dash Gastos');
                        }
                    });
                },
                error: function (xhr) 
                {
                    console.log('php/dash_finanzas_buscar2.php --> '+JSON.stringify(xhr));
                    mandarMensaje('* No se encontró información de Detalle Dash Gastos');
                }
            });
