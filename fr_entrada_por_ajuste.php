            ...
            <br>
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="titulo_ban">Entrada Por Ajuste</div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-4">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input type="text" id="i_tipo_entrada" name="i_tipo_entrada" value="E99 Entrada Por Ajuste" class="form-control form-control-sm" autocomplete="off" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Búsqueda de  Entradas Por Ajuste</h5>
    ...
    $(function(){
        ...
        $('#b_imprimir').click(function(){
            ...
            var datos = {
                ...
                'tipo':1,
                'concepto':'E99 Entrada Por Ajuste'
            };
