                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4"> 
                                ...
                                <!--<table>
                                    <tr>
                                        <td>
                                            <label for="ch_comodato">Comodato</label>
                                        </td>
                                        <td>Comodato
                                            <input type="checkbox" name="ch_comodato" id="ch_comodato" class="form-control">
                                        </td>
                                    </tr>
                                </table>-->                               
                ...
                <div class="row" id="div_detalle_requisiciones">
                    <!--<div class="col-sm-12 col-md-12">-->
                        ...
                        <div id="div_t_detalle_requisiciones">
                            <table class="tablon table-striped" id="t_detalle_requisiciones">
                                <thead>
                                    <tr class="renglon_encabezado">
                                        <th scope="col" width='100px;'>Folio</th>
                                        <th scope="col" width='100px;'>Sucursal</th>
                                        <th scope="col" width='100px;'>Area</th>
                                        <th scope="col" width='100px;'>Depto</th>
                                        <th scope="col" width='100px;'>OC</th>
                                        <th scope="col" width='100px;'>Fecha</th>
                                        <th scope="col" width='100px;'>Solicita</th>
                                        <th scope="col" width='100px;'>Proveedor</th>
                                        <th scope="col" width='100px;'>Partida</th>
                                        <th scope="col" width='100px;'>Familia</th>
                                        <th scope="col" width='100px;'>Línea</th>
                                        <th scope="col" width='100px;'>Descripción</th>
                                        <th scope="col" width='100px;'>Detalle</th>
                                        <th scope="col" width='100px;'>Unidad</th>
                                        <th scope="col" width='100px;'>Cantidad</th>
                                        <th scope="col" width='100px;'>Costo U</th>
                                        <th scope="col" width='100px;'>Descuento T</th>
                                        <th scope="col" width='100px;'>% IVA</th>
                                        <th scope="col" width='100px;'>Importe sin IVA</th>
                                        <th scope="col" width='100px;'>Importe con IVA</th>
                                        <th scope="col" width='100px;'>Estatus</th>
                                    </tr>
                                </thead>
                                <tbody>
                        ...
                        <table class="tablon">
                            <thead>
                                <tr class="renglon_encabezado">
                                    ...
                                    <th scope="col">Autorizó Fuera Presupuesto</th>
...
<script>
    ...
    $(function(){
        ...
        function muestraSucursalesTodas()//modulo,idUsuario
        {
            ...
            //console.log(cadenaSuc);

        }

        function buscaDetalleRequisicionesTodas(cadenaSucursales)
        {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: 'php/requisiciones_reportes_buscar_todas.php',
                dataType:"json", 
                data:{'datos':datos},
                success: function(data) {
                    if(data.length != 0){
                        ...
                        for(var i=0;data.length>i;i++){
                            ...
                            var html='<tr class="renglon">\
                                        ...
                                        <td data-label="Dcto">'+formatearNumero(data[i].descuento_total)+'</td>\
                ...
                error: function (xhr) 
                {
                    console.log('php/requisiciones_reportes_buscar_todas.php --> '+JSON.stringify(xhr));
                    mandarMensaje('Error en el sistema');
                }
            });
        }

        function buscaRequisicionesAgrupadasTodas(cadenaSucursales)
        {


            // verificando uno
            $('#t_requisiciones_agrupadas .renglon').remove();
            let prov = $("#i_proveedor").prop("alt");
                    ...
                    if(data.length != 0){
                        ...
                        for(var i=0;data.length>i;i++){
                            ...
                            var html='<tr class="renglon">\
                                        ...
                                        <td data-label="Depto">'+data[i].depto+'</td>\
                                        <td data-label="OC">'+data[i].folio_orden_compra+'</td>\
                                        <td data-label="Anticipo">'+data[i].anticipo+'</td>\
                                        <td data-label="Fecha">'+data[i].fecha+'</td>\
                                        <td data-label="Solicita">'+data[i].solicito+'</td>\
                                        <td data-label="Autorizó Fuera Presupuesto">'+data[i].autorizo_fuera_presupuesto+'</td>\
                                        <td data-label="Autorizó">'+data[i].autorizo+'</td>\
                                        <td data-label="Proveedor">'+data[i].proveedor+'</td>\
                                        ...
                                        <td data-label="Estatus">'+data[i].estatus+'</td>\
                                        <td data-label="Fecha Pago">'+data[i].fechaPago+'</td>\
                                    </tr>';
                            ///agrega la tabla creada al div 
        ...
        function buscaBackorderRequisicionesTodas(cadenaSucursales)
        {
        ...
        $('#ch_todas').change(function()
        {
            ...
            if($('#ch_todas').prop("checked") == true)
            {
                ...
                {  
                    ...
                    $('#div_agrupadas_requisiciones').css('display','none');
                    $('#div_backorder_requisiciones').css('display','none');
                    buscaDetalleRequisicionesTodas(cadenaSuc);
                ...
                {  
                    ...
                    $('#div_detalle_requisiciones').css('display','none');
                    $('#div_backorder_requisiciones').css('display','none');
                    buscaRequisicionesAgrupadasTodas(cadenaSuc);
                ...
                else
                {
                    ...
                    $('#div_agrupadas_requisiciones').css('display','none');
                    $('#div_detalle_requisiciones').css('display','none');
                    buscaBackorderRequisicionesTodas(cadenaSuc);
                    ...
                    if(data.length != 0){
                        ...
                        for(var i=0;data.length>i;i++){
                            ...
                            var html='<tr class="renglon">\
                                        ...
                                        <td data-label="Fecha">'+data[i].fecha+'</td>\
                                        <td data-label="Solicita">'+data[i].solicito+'</td>\
                                        <td data-label="Solicita">'+data[i].quienCapturo+'</td>\
                                        <td data-label="Autorizó Fuera Presupuesto">'+data[i].autorizo_fuera_presupuesto+'</td>\
                                        <td data-label="Autorizó">'+data[i].autorizo+'</td>\
                                        <td data-label="Proveedor">'+data[i].proveedor+'</td>\
                                        <td data-label="Descripción General">'+data[i].descripcion+'</td>\
        ...
        $('#b_excel').click(function(){
            ...
            if($('#ch_todas').prop("checked") == true)
            {
                ...
                var datos = {
                    'fechaInicio':$('#i_fecha_inicio').val(),
                    'fechaFin':$('#i_fecha_fin').val(),
                    'idSucursal':cadenaSuc,
                    prov
                };

                $("#i_nombre_excel").val(nombreReporte);
                $("#i_fecha_excel").val(hoy);
                $('#i_modulo_excel').val('REPORTES_REQUISICIONES_TODAS');
