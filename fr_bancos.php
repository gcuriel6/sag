            ...
            <br>
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="titulo_ban">Bancos</div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 col-md-10">
                        <form id="forma" name="forma">
                            <div class="form-group row">
                                <label for="i_id_banco" class="col-sm-2 col-md-2 col-form-label">ID </label>
                                <div class="col-sm-12 col-md-3">
                                    <input type="text" class="form-control"  id="i_id_banco" autocomplete="off" disabled="disabled">
                                </div>
                            </div>
                           <div class="form-group row">
...
<script>
    ...
    $(function(){
                ...
                success: function(data) {
                   ...
                   if(data.length != 0){
                        ...
                        for(var i=0;data.length>i;i++){
                            ...
                            var html='<tr class="renglon_bancos" alt="'+data[i].id+'">\
        ...
        function muestraRegistro(){ 
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    idBanco=data[0].id;
                    bancoOriginal=data[0].clave;
                    $('#i_clave').val(data[0].clave);
                    $('#i_id_banco').val(idBanco);
                    $('#i_descripcion').val(data[0].banco);
                ...
                error: function (xhr) {
                    console.log('php/bancos_buscar_id.php-->'+JSON.stringify(xhr));
            ...
            $.ajax({
                ...
                success: function(data) 
                {
                    if(data == 1){
                        ...
                        if (tipoMov == 1 && bancoOriginal === $('#i_clave').val()) {
                            guardar();
                        } else {
        ...
        function guardar(){
         ...
         $.ajax({
                ...
                success: function(data){
                 ...
                 error: function(xhr){
                    console.log('php/bancos_guardar.php-->'+JSON.stringify(xhr));
                    mandarMensaje("* Ha ocurrido un error al guardar un nuevo Banco.");
                    $('#b_guardar').prop('disabled',false);
                }
            });
        ...
        $('#b_excel').click(function(){
            ...
            $('#i_nombre_excel').val('Registros Bancos');
            $('#i_fecha_excel').val(hoy);
            $('#i_modulo_excel').val('BANCOS');
