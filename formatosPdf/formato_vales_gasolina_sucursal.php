...
<table width="930" border="0">
    <tr>
        <td width="930" class="datos" align="center" >
            <br><br><br>
            <strong>Reportes de Vales de Gasolina</strong>
            <br><br><br>
        </td>
    </tr>
</table>
...
<table width="930" class='borde_tabla'>
    <tr class="encabezado">
        <td width="40" align="ceter" >FOLIO</td>
        <td width="80"  align="ceter" >UNIDAD DE<BR> NEGOCIO</td>
        <td width="80" align="ceter" >SUCURSAL</td>
        <td width="100"  align="ceter" >ÁREA</td>
        <td width="100"  align="ceter" >DEPARTAMENTO</td>
        <td width="110"  align="ceter" >EMPLEADO</td>
        <td width="110"  align="ceter" >OBSERVACIONES</td>
        <td width="70" align="ceter" >FECHA</td>
        <td width="70"  align="ceter" >NO<BR> ECONOMICO</td>
        <td width="100"  align="ceter" >CONCEPTO</td>
        <td width="80"  align="ceter" >MONTO</td>
    </tr>
    <?php
        $query = "SELECT IFNULL(a.folio,'') AS folio,c.nombre AS unidad_negocio,d.descr AS sucursal,e.descripcion AS area,f.des_dep AS departamento,a.no_economico,
        ...
        {
            echo '<tr>';
            echo '<td class="datos">' .$row['folio']. '</td>';
            echo '<td class="datos">' . normaliza($row['unidad_negocio'],10) . '</td>';
            echo '<td class="datos">' . normaliza($row['sucursal'],8) . '</td>';
            ...
            echo '<td class="datos">' . normaliza($row['no_economico'],8) . '</td>';
