...
$query = "SELECT a.id,
            ...
            LEFT JOIN deptos h ON c.id_depto=h.id_depto
...
<table class="borde_tabla" width="720">
    <thead>
        <tr class="encabezado">
            ...
            <td width='130' align="center">Concepto</td>
            <td width='62' align="center">Talla</td>
            <td width='80' align="center">Marca</td>
            <td width='50' align="center">Cant</td>
            <td width='60' align="center">Precio Unitario</td>
    ...
    while ($rowE = mysqli_fetch_array($consultaE)){
       ...
       $tPrecioTotal = $tPrecioTotal + $rowE['importe'];
        ...
        echo   "<tr>
                    ...
                    <td width='130'>".$rowE['concepto']."</td> 
                    <td width='62'>".$rowE['talla']."</td> 
                    <td width='80'>".$rowE['marca']."</td>
                    <td width='50' align='right'>".$rowE['cantidad']."</td> 
                    <td width='60' align='right'> ".dos_decimales($rowE['precio'])."</td>
...
<br><br><br><br><br>
<!-- NJES August/14/2020 agregar linea con empleado a quien se asigna uniforme para firma en salida por uniforme-->
<?php if($cve_concepto == 'S02'){ ?>
    <table>
        <tr>
