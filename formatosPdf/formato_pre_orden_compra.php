...
<table width="710" border="0">
    <tr>
        ...
        <td width="400" class="datos" align="center" ><strong>PRE - ORDEN DE COMPRA</strong> <br>
...
<table class='borde_tabla' width='710'>
    <tr>
        ...
        <td class="verde" width="177" align='center'>Condiciones de Pago</td>
...
<table class="borde_tabla" width="710">
    <thead>
        <tr class="encabezado">
            <td width='80' align="center">Catálogo </td>
    ...
    while ($rowE = mysqli_fetch_array($consultaE)){
       ...
       if($rowE['descuento'] > 0){
        ...
        echo   "<tr>
                    ...
                    <td>".normaliza($rowE['concepto'],25)."</td> 
                    <td>".$rowE['tallas']."</td> 
    ...
    <tfoot>
        <tr>
            <td colspan="5" rowspan="4"><strong> Observaciones: </strong><?php echo $observacion;?></td>
