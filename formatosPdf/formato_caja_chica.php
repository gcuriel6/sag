...
$query = "SELECT a.folio AS folio,a.estatus AS estatus,b.nombre AS unidad,b.logo AS logo,c.descr AS sucursal,c.codigopostal,
            ...
            IF(a.id_empleado=0,'Externo',f.cve_nom) AS num_nomina,a.importe,a.observaciones,g.des_dep AS departamento,
            CONCAT(h.clave,' ',h.descripcion) AS concepto_caja_chica
            FROM caja_chica a
            ...
            LEFT JOIN conceptos_cxp h ON a.id_concepto=h.id
...
<table width="710" border="0">
    <tr>
        ...
        <td width="460" class="datos" align="center" ><strong>Comprobante de Caja Chica</strong> <br>
...
<table width="710" class='borde_tabla'>
    <tr>
        <td class="verde">Concepto: </td>
        <td><?php echo $rowU['concepto_caja_chica'] ?></td>
    </tr>
    <tr>
        <td class="verde">Observaciones: </td>
        <!--NJES March/12/2020 normalizar textos para que no sobrepase el margen-->
        <td><?php echo normaliza($rowU['observaciones'],102) ?></td>
    </tr>
</table>
...
<table width="710" class='borde_tabla'>
    <tr class="encabezado">
        <td width="110" class="verde" align="left" >No. Nómina</td>
        <td width="270" class="verde" align="left" >Nombre</td>
        <td width="240" class="verde" align="left" >Departamento</td>
        <td width="130" class="verde" align="left" >Monto</td>
    </tr>
    <tr>
        <td class="datos" align="left" ><?php echo $rowU['num_nomina'] ?></td>
        <td class="datos" align="left" ><?php echo normaliza($rowU['empleado'],35) ?></td>
        <td class="datos" align="left" ><?php echo normaliza($rowU['departamento'],32) ?></td>
