...
<table class="borde_tabla" width="710">
    ...
    <tr>
        ...
        <td width='360'><table border="0" class="borde_tabla2"><tr><td width="180">Orden de compra </td><td width="180" align="right"><?php echo $folioOC;?></td></tr></table></td>
    ...
    <tr>
        ...
        <td width='360' rowspan="2">&nbsp;&nbsp;Proveedor<br> &nbsp;&nbsp;<?php echo $proveedor;?></td>
    ...
    <tr>
        <td width='260'><table border="0" class="borde_tabla2"><tr><td width="100">Importe  </td><td width="160" align="right"><?php echo dos_decimales($importe);?></td></tr></table></td>
    </tr>
