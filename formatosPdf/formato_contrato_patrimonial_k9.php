...
<table border="0" width="660" class="texto">
    ...
    <tr>
        <td width="660">
            ...
            Contrato de prestación de servicios profesionales de vigilancia y protección K-9 que celebran por una parte, <strong style="text-decoration: underline solid black;">“<?php echo $rs_cliente;?>”</strong>, representada en este acto por <strong style="text-decoration: underline solid black;">“<?php echo $r_legal;?>”</strong> a quien en lo sucesivo se le denominará <strong>“EL CLIENTE”</strong>   y por la otra parte <strong>“SECORP ALARMAS DE JUAREZ” S. DE R.L DE C.V.”</strong> ,  representada en este acto por el <strong>LIC. JORGE GINTHER ARZAGA</strong>, a quien en lo sucesivo se le denominará <strong>“EL PRESTADOR DEL SERVICIO”</strong>, los cuales se someten al contenido de las siguientes declaraciones y cláusulas.
            <br><br>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <strong>I.-</strong> Declara <strong>“EL CLIENTE”</strong>  que su representada es una persona moral, constituida bajo las leyes mexicanas, cuyas instalaciones se ubican en (<strong style="text-decoration: underline solid black;">“<?php echo $domicilio.' No. '. $no_exterior.($no_interior!='')?'INT. '.$no_interior:'';?>”</strong>), Código Postal <strong style="text-decoration: underline solid black;">“<?php echo $codigo_postal;?>”</strong> de Ciudad <strong style="text-decoration: underline solid black;">“<?php echo $municipio.", ".$estado;?>”</strong>, tributando bajo el número de Registro Federal de Contribuyentes<br> <strong>“<?php echo $rfc;?>”</strong>.
            <br><br><br>
   ...
   <tr>
    ...
    <tr>
        <td align="center">
            ...
            ------------------------
            <br><br>
            <strong><?php echo $r_legal;?><br>Representante legal de
            <br>
            “ <?php echo $rs_cliente;?>” </strong>
