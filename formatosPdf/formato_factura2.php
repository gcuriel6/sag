...
<table>
    <tr>
        <td width="110" class="bordePadSeg">SERIE Y FOLIO<br>
            <div class="font_light" align="right" style="font-size:14px;"> <?php echo $folio; ?></div>
        </td>
        <td width="110" class="bordePadSeg">REGIMEN FISCAL<br>
            <label class="font_light"><?php echo $regimenfiscal; ?></label>
        </td>
        <td width="110" class="bordePadSeg">METODO DE PAGO<br>
            <label class="font_light"><?php echo $metodo_pago; ?></label>
        </td>
        <td width="110" class="bordePadSeg">FORMA DE PAGO<br>
            <label class="font_light"><?php echo $forma_pago; ?></label>
        </td>
        <td width="110" class="bordePadSeg">USO DE CFDI<br>
            <label class="font_light"><?php echo $uso_cfdi; ?></label>
        </td>
        <td width="110" class="bordePadSeg">TIPO DE COMPROBANTE<br>
            <label class="font_light">I - Ingreso</label>
        </td>
    </tr>
</table>
<table>
    ...
    <tr>
        ...
        <td width="173" class="bordePad">
            <table>
                ...
                if(!$tipo_factura == 'Recibo Deducible'){
                    ?>
                    <tr>
                        <td>Iva</td>
...
<table>
    <tr>
        <td style="width:100%" class="bordePad">
                 <label >Complemento Donatarias</label>   
        </td>
    </tr>
    <tr>
        <td style="width:100%" class="bordePad">
                <label>Numero de autorización: 700-02-01-00-00-2021-8411</label><br>
                <label>Fecha de autorización: 2021-10-15</label><br>
                <label>Leyenda:</label>
                <p>
                    Este comprobante ampara un donativo, el cual sera destinado por la donataria a los fines propios de su objecto social. En el caso de los bienes donados hayan sido deducidos previamente para los efecto del impuesto sobre la renta,
                    este donativo no es deducible. La reproduccion no autorizada de este complemento constituye a un delito en los terminos de las disposiciones fiscales.
                </p>
                <p>*En el caso de que la donacion se realice a una entidad publica en este campo se debera registrar la palabra "Gobierno"</p>
        </td>
    </tr>
</table>
<?php if($tipo_factura == 'Factura' || $tipo_factura == 'Recibo' || $tipo_factura == 'Recibo Deducible') { ?>
